...
import  InsertUser from '../../Actions/Register/Student';
...
handleSubmit = (event) => {
  ...
  if(this.isValid(this.state.errors)){
      ...
      this.state.email, this.state.age, this.state.gender, this.state.grade_or_year, this.state.phone_number, this.state.student_type);
      if(!is_insert){
